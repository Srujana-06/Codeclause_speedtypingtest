...
def game():
    ...
    words = ['hardwork', 'life','college', 'internship', 'codeclause']
    ...
    b2 = Button(windows, text="Done",
                command=check_result, width=12, bg='white')
    b2.place(x=150, y=100)

    b3 = Button(windows, text="Try Again",
                command=game, width=12, bg='white')
...
b1 = Button(window, text="Go", command=game, width=12, bg='white')
